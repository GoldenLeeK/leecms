          ...
          <table class="table table-sm table-striped">
            <thead>
              <tr>
                ...
                <th>Id</th> <th>Name</th> <th>Description</th> <th>Article_count</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$category->id}}</td> <td>{{$category->name}}</td> <td>{{$category->description}}</td> <td>{{$category->article_count}}</td>
